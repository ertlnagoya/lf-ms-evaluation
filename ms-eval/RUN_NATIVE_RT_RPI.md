# Native real-hardware evaluation on Raspberry Pi (PREEMPT_RT + core isolation)
...
## 8. Natural-timescale (1 ms) check — the point of native real-hardware
...
- Update §Threats to Validity: change "virtualized host / future native real-hardware" to
...
A Japanese version of this guide is in `RUN_NATIVE_RT_RPI.ja.md`.
